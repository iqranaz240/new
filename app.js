...
//     //     document.getElementById('validation').innerText = "Enter names"
//     // }
...
// function makeLarge() {
//     document.getElementById("text").className += " large";
// }
...
let t = document.childNodes[0].childNodes[1].childNodes[1].childNodes[1];
console.log(t)